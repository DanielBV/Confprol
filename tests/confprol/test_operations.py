...
class TestOperations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.boolean_true = BasicExpression(ConfprolObject(True), True, ValueType.BOOLEAN)
        self.boolean_false = BasicExpression(ConfprolObject(False), False, ValueType.BOOLEAN)
        self.string1 = BasicExpression(ConfprolObject("firstString"), "firstString", ValueType.STRING)
        self.string2 = BasicExpression(ConfprolObject("secondString"), "secondString", ValueType.STRING)
